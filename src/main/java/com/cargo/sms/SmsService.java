...
public static String SendSMS(String ID,String PWD, String MobileNos,String text){
	// Base URL        
	...
	try {
		...
		String urlParameters = "ID="+ URLEncoder.encode(ID, "UTF-8")+"&Pwd="+URLEncoder.encode(PWD, "UTF-8")+"&PhNo="+URLEncoder.encode(MobileNos, "UTF-8")+"&Text="+URLEncoder.encode(text, "UTF-8")+"&TemplateID="+URLEncoder.encode(templateId, "UTF-8");
	...
	public void sendSignupOTPMobile(String verifymobiletokenString, String mobilenumber) {
		...
		String ID="hrushikeshjoshi@absortio.com";
		String PWD="BookMyCargo@2021";
		String MobileNos=mobilenumber;
		String SMSText="Your OTP for mobile registration is "+verifymobiletokenString+".";
